...
class Options:
    ...
    def __init__(self):
        ...
        # self.parser.add_argument(
        #     "--device", type=str, default="gpu", help="Device: gpu | cpu"
        # )
        # self.parser.add_argument(
        #     "--gpu_ids",
        #     type=str,
        ...
        self.parser.add_argument(
            "--manualseed", default=-1, type=int, help="manual seed or -1 for no seed"
        )
        ...
        self.parser.add_argument(
            "--w_gamma", type=float, default=1, help="Gamma weight"
        )
        self.parser.add_argument(
            "--w_es", type=float, default=0.1, help="Encoder loss weight"
        )
        self.parser.add_argument(
            "--w_e0", type=float, default=10, help="Encoder loss weight"
        )
        self.parser.add_argument(
            "--w_g", type=float, default=100, help="Generator loss weight."
        )
        self.isTrain = True
        self.opt = None
